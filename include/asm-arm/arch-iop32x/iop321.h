...
/** Physical Address used for resource alloc */
#define IOP321_REG_PA(reg) \
        ((((unsigned long)(reg))&~IOP321_VIRT_MEM_BASE)|IOP321_PHYS_MEM_BASE)
